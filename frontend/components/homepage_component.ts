        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Find out why Legal Estate is the leading practice management solution for law firms.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-blue-50 p-8 rounded-lg">
              <p className="text-gray-700 mb-6 italic">
                "Legal Estate is like an iPhone for law firms. You just pick it up, and you can figure it out 
                without any instructions. The interface is incredibly intuitive."
              </p>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">Managing Partner, Davidson & Associates</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 p-8 rounded-lg">
              <p className="text-gray-700 mb-6 italic">
                "The customer service is exceptional. I have never experienced better client attentiveness 
                from any software company. They truly care about our success."
              </p>
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">Senior Attorney, Martinez Law Group</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-purple-50 p-8 rounded-lg">
              <p className="text-gray-700 mb-6 italic">
                "Legal Estate allows for easy case management from beginning to end. It's helped us become 
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">Founder, Johnson Legal Services</p>
                </div>
              </div>
            </div>
          </div>
